...
int main(void)
{
  ...
  while (1)
  {
	    ...
	    if (batch != 1) {
	        ...
	        // 3. 結果出力（モータトルク�?令値?�?
	        // PPO の Tanh 出力�?�ため -1.0 �? 1.0 の�?囲になる�?��?
